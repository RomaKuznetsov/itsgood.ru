...
import com.itsgood.ru.service.RoleDataService;
...
public class CustomerDataController {
    ...
    public ResponseEntity<CustomerDTO> createCustomer(@Validated @RequestBody CustomerRequestCreate request,
        ...
        roleRequestCreate.setCustomer_id(customerDTO.getId());
        roleDataService.createRole(roleRequestCreate);
        ContractRequestCreate contractRequestCreate = new ContractRequestCreate();
        contractRequestCreate.setCustomer_id(customerDTO.getId());
        contractDataService.createContract(contractRequestCreate);
